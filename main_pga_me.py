...
@hydra.main(version_base=None, config_path="configs/", config_name="pga_me")
def main(config: DictConfig) -> None:
    ...
    metrics = dict.fromkeys(["iteration", "qd_score", "coverage", "max_fitness", "qd_score_repertoire", "dem_repertoire", "actor_fitness", "ga_offspring_added", "qpg_offspring_added", "ai_offspring_added", "ga_improvement", "qpg_improvement", "ai_improvement", "time"], jnp.array([]))
