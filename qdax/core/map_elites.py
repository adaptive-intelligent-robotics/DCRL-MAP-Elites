...
class MAPElites:
    ...
    def init(
        ...
        # init the repertoire
        repertoire, is_offspring_added, improvement = MapElitesRepertoire.init(
        ...
        return repertoire, emitter_state, is_offspring_added, improvement, random_key
    ...
    def update(
        ...
        repertoire, is_offspring_added, improvement = repertoire.add(genotypes, descriptors, fitnesses, extra_scores)
